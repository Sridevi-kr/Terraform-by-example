...
#To run environment specific values you need to run as terraform plan --var-file=dev.tfvars
#terraform apply --var-file=dev.tfvars(same command you can run using prod.tfvars)
